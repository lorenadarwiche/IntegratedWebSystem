...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        //and it will provide links back to the mainpage and the homepage!
            ...
            echo "<center><br><h2><a href='homepage.html'>Go back to Homepage to login again!</a></h2></center>";
    ...
    //and it will provide links back to the mainpage and the homepage!
        ...
        echo "<center><h2><br><a href='<center><br><h2><a href='homepage.html'>Go back to Homepage to login again!</a></h2></center>";
